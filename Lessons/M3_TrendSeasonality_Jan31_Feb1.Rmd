...
raw_inflow_data <- read.table(file="/Users/karenthornton/Documents/School/Grad School/Year 2/Semester 2/Time Series/TimeSeriesAnalysis_Sp23/Data/inflowtimeseries.txt",header=FALSE,skip=0)
...
#can use residuals function as well
#diff(inflow_data, linear_trend)
...
#All the means are relative to December, which is why some of them are negative
#mean would be the intercept plus the estimated std. of that specific month
#so mean of December is the intercept
# you SHOULD be using the detrended dataset instead of the original
...
print(adf.test(ts_inflow_data[,iHP]), alternative = "stationarity")#explosive instead of alternative
