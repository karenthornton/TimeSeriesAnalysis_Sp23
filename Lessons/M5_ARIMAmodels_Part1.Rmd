...
- if determinist: use regression
- AR processes have a relatively long memory 
- the short memory family  of models is moving average (MA) (move around zero??)
- MA has no "memory": can go from one extreme for the other with one jump (messy looking)
...
#drift = being more generous with ARIMA model
#drift always going to be near zero
print(Model_111)
