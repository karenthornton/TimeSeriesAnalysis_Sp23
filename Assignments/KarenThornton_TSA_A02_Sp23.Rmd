...
```{r}
Renewable_Energy <- select(Renewable_Energy, c("Month","Total.Biomass.Energy.Production","Total.Renewable.Energy.Production","Hydroelectric.Power.Consumption"))
...
ts_Rewnewable_Energy <- ts(Renewable_Energy[,2:(2+nenergy-1)], frequency = 12, start = 1)
ts_Rewnewable_Energy
```
...
```{r}
mean(ts_Rewnewable_Energy[,1])
mean(ts_Rewnewable_Energy[,2])
mean(ts_Rewnewable_Energy[,3])

sd(ts_Rewnewable_Energy[,1])
sd(ts_Rewnewable_Energy[,2])
sd(ts_Rewnewable_Energy[,3])
```
