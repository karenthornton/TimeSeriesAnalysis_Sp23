...
inflow_deseason_df<-merge(inflow_deseason_df, inflow_model_dates$Date)
colnames(inflow_deseason_df) <- c("Inflow", "Date")

#plot
ggplot()+
  geom_line(inflow_model_dates, mapping=aes(x=Date, y=V17))+
  geom_line(inflow_deseason_df, mapping=aes(x=Date, y=Inflow, color="red"))+
