...
#computed is coefficient from a and b
#theoretical is th one you specified. phi = p?? (is the lag one =0.6)
#only for the AR
#coeficcients for the MA not shown??
...
#no constant term, so the series has been differenced, you can get the d value from that

#little d and big D, think of the constants, make an assumption, zero or 1 based on if the constant is in the equation or not

(b) Also from the equation what are the values of the parameters, i.e., model coefficients. 

#regression coefficient
#whats the ar1 coefficient
